...
BALSEONG_API_URL = os.getenv('BALSEONG_API_URL', 'https://balsong.com/Linkage/API/')
BALSEONG_USER_ID = os.getenv('BALSEONG_USER_ID', '')
BALSEONG_USER_PW = os.getenv('BALSEONG_USER_PW', '')
BALSEONG_CALLBACK = os.getenv('BALSEONG_CALLBACK', '')
BALSEONG_DRY_RUN = os.getenv('BALSEONG_DRY_RUN', '1' if not (BALSEONG_USER_ID and BALSEONG_USER_PW and BALSEONG_CALLBACK) else '0') == '1'
